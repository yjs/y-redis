...
const authTokenRequest = await fetch(`http://${location.host}/auth/${room}`)
const authToken = await authTokenRequest.text()

const ydoc = new Y.Doc()
const provider = new WebsocketProvider(`ws://${location.host}/ws`, room, ydoc, { params: { yauth: authToken } })
